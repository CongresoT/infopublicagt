                ...
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <div class="progress-border">
                            <div class="progress-green progress-bar" style="height:24px;width:{{ $upPerc }}%">{{ number_format($upPerc,2) }}% de los sujetos obligados</div>
                        </div>
                    </div>
            ...
            <div class="panel-group" id="middleSo">
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <div class="progress-border">
                            <div class="progress-yellow progress-bar" style="height:24px;width:{{ $equalPerc }}%">{{ number_format($equalPerc,2) }}% de los sujetos obligados</div>
                        </div>
                    </div>
            ...
            <div class="panel-group" id="lowerSo">
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <div class="progress-border">
                            <div class="progress-red progress-bar" style="height:24px;width:{{ $downPerc }}%">{{ number_format($downPerc,2) }}% de los sujetos obligados</div>
                        </div>
                    </div>
