...
<script>
    ...
    // Define the axes
    var xAxis = d3.axisBottom(x).ticks({{ sizeof($tracksSubject) }});
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
				...
				<h6 class="center-block">Nivel de cumplimiento</h6>
            </div>
            <div class="col-xs-4">
                <div id="advancement" class="center-block">
                    ...
                    <div @if($advancement > 0) class="progress-qty-green" @elseif($advancement < 0) class="progress-qty-red" @else  class="progress-qty-yellow" @endif>@if(!empty($advancement)){{ number_format(abs($advancement),1) }}%@else = @endif</div>
                </div>
