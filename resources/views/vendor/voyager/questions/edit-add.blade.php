...
@section('page_header')
    <h1 class="page-title">
        {{ $dataTypeContent['relations']['indicatorId']['original']['question'] }}
		<a href="{{ url('/admin/trackquestions', $dataTypeContent->track_id) }}" class="btn btn-success">
			<i class="voyager-double-left"></i> Regresar a las preguntas
		</a>
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                        ...
                        <div class="panel-footer">
                            <button type="submit" class="btn btn-primary save">Guardar y siguiente</button>
                        </div>
                    </form>
