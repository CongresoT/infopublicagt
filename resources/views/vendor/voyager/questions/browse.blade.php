...
@section('page_header')
    <h1 class="page-title">
		...
		<a href="{{ url('/admin/tracks') }}" class="btn btn-success">
			<i class="voyager-double-left"></i> Regresar a Listado de S.O.
		</a>
    </h1>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                ...
                                                @if($row->type == 'radio_btn')
                                                    @if (($data->{$row->field} == 'Y')||($data->{$row->field} == 'N')||($data->{$row->field} == 'NA'))
                                                        <div class="btn btn-success">{{ $data->{$row->field} }}</div>
                                                    @else
                                                        <div class="btn btn-danger">Sin Contestar</div>
                                                    @endif
                                                @else
                                    ...
                                    <td class="no-sort no-click" id="bread-actions">
                                        @if (Voyager::can('edit_'.$dataType->name))
                                            <a href="{{ route('voyager.'.$dataType->slug.'.edit', $data->id) }}" title="Edit" class="btn btn-sm btn-primary pull-right edit">
                                                <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Responder</span>
                                            </a>
                                        @endif
                                    </td>
                                </tr>
