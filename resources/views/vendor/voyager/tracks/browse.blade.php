...
@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i> Sujetos obligados monitoreados en la ronda
		<a href="{{ url('/admin/addtracks', $round->id) }}" class="btn btn-success">
			<i class="voyager-plus"></i> Agregar S.O. activos
		</a>
    </h1>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="no-sort no-click" id="bread-actions">
										<a href="{{ url('/admin/trackquestions', $data->id) }}" title="Edit" class="btn btn-sm btn-primary pull-right edit">
											<i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">Preguntas</span>
										</a>
                                    </td>
                                </tr>
                                @endforeach
