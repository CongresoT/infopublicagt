...
@if(isset($dataTypeContent->id))
    @section('page_title','Editar sector')
@else
    @section('page_title','Agregar sector')
@endif

@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i> @if(isset($dataTypeContent->id)){{ 'Editar' }}@else{{ 'Nuevo' }}@endif sector
    </h1>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">@if(isset($dataTypeContent->id)){{ 'Editar' }}@else{{ 'Agregar' }}@endif sector</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form"
